...
void test_empty_full() {
    ...
    require(ring.try_push(4), "push 4 — ring stores a full capacity");
...
int main() {
    try {
        ...
        std::cerr << "test_spsc FAILED: " << ex.what() << '\n';
        return 1;
    }
    std::cout << "test_spsc OK\n";
    return 0;
}
